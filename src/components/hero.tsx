export const Hero = () => {
    return (
        <section className="mt-[180px] md:mt-[100px] flex flex-col  gap-10 p-[20px] md:p-[50px]">
        ...
        <button className="bg-green-500 text-white px-10 py-3 rounded-full hover:bg-green-700">Join us now</button>
        <button className=" text-white px-10 py-3 rounded-full border border-green-700 hover:bg-green-700">Learn More</button>
        </div>
      </section>
    )
}